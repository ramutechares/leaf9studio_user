...
import holi from "../assets/images/street/holi.png";
import dasara from "../assets/images/street/dasara.png";
import Chariot from "../assets/images/street/Chariot.png";
...
const Street = () => {
    ...
    <div>
      <section>
        <div className="inner-head-pad">
          <h1 className="text-center">Street Photography</h1>
        </div>
      </section>
  ...
  "https://www.youtube.com/embed/V55Pebu6Drw?si=iH9ophNBu2fNFguw",
  dasara
)}
...
{renderVideoBlock(
  "Chariot Festival",
  "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.",
  "https://www.youtube.com/embed/Bxx6Zs4gsnA?si=42BRJF7Jf-LK-lOB",
  Chariot,
  true
)}
...
{renderVideoBlock(
  "Yellow Festival",
  "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.",
  "https://www.youtube.com/embed/q7naYFNizBM?si=Ofr7D2gVwlFwVSGw",
  holi
)}
      {/* Modal */}
